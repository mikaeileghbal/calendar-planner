...
UI.prototype.render = function () {
  ...
  if (this.View_Mode === viewModes.YEAR_VIEW) {
    ...
    console.log("month: ", this.calendar.getMonthCalenar(this.calendar.date));
  }
...
UI.prototype.setView = function (mode) {
  this.View_Mode = viewModes[mode];
  console.log("mode:", this.View_Mode);
};
